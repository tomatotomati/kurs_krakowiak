...
mask = cv2.threshold(src=gray, thresh=220, maxval=255, type=cv2.THRESH_BINARY)[1] # indeks 1 bo threshold zwraca 2 wartości a my chcemy tę drugą czyli indeks 1
mask_inv = cv2.bitwise_not(mask)
# mask_inv = cv2.threshold(src=gray, thresh=220, maxval=255, type=cv2.THRESH_BINARY_INV)[1]
